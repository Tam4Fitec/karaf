DROP TABLE IF EXISTS tb_shopsite_state;

CREATE TABLE tb_shopsite_state (
...
INSERT INTO tb_shopsite_state VALUES ('2094', '50', '16', '30', 'p', 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'Y', 'N', 'N', 'A', '10', '1', NULL, '32767');
