 ...
 */
public class WebSOffersRequestWithKSite extends AbstractWebsRequest {

    public WebSOffersRequestWithKSite(String host, String port, String lang, String ksite) throws InvalidWebsRequestException {
        this.host=host;
        this.port=port;
        ...
        parameters.put(WebSOfferField.KSITE, new RequestParameter<>(WebSOfferField.KSITE,true, ksite));
    }
