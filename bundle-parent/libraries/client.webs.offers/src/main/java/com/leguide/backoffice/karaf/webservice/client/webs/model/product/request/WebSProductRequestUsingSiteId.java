 ...
 */
public class WebSProductRequestUsingSiteId extends AbstractWebsRequest {


    public WebSProductRequestUsingSiteId(String host, String port, String lang, String siteId, String productId) throws InvalidWebsRequestException {
        this.host=host;
        this.port=port;
        ...
        parameters.put(WebSProductField.SITE_ID, new RequestParameter<>(WebSProductField.SITE_ID,true, siteId));
